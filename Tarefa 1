...
alter table alunos
modify column cursos varchar(40) after nome;
...
aulasdadas int (10) unsigned default null,
...
drop table alunos;
drop table cursos;
drop table cursos_realizados;

select * from alunos;
select * from cursos;
select * from cursos_realizados;

desc alunos;
desc cursos;
desc cursos_realizados;

select alunos.nome, cursos.nome, cursos.ano, cursos_realizados.data
from((alunos join cursos_realizados on alunos.ra = cursos_realizados.ra) join cursos on cursos.idcursos = cursos_realizados.idcursos)
where cursos_realizados.data between '2010-01-01' and '2016-12-31';

select * from cursos, alunos, cursos_realizados;

select cursos.idcursos, alunos.ra, alunos.nome, cursos.nome
from alunos
join cursos on cursos.idcursos
where idcursos = '8' AND ra = '11' or idcursos = '8' AND ra = '10';

select alunos.ra, alunos.nome, cursos_realizados.idcursos 
from cursos_realizados 
join alunos on (alunos.ra = cursos_realizados.ra)
where idcursos = '8';

INSERT INTO alunos
   (ra, nome, cursos, nascimento, sexo, peso, altura, nacionalidade)
   VALUES
...
('60','Dayan Dias','Professor','1993-05-30','F',88.30,1.66,'Angola'),
('61','Silvana Albuquerque','Programador','1999-05-22','F',56.00,1.50,'Brasil');
   
INSERT INTO cursos
   (idcursos, nome, descricao, ch, aulasdadas, ano)
   VALUES
...
(default,'2014-01-22','01','12'),
(default,'2016-05-22','01','19'),
(default,'2017-08-22','11','20');
...
SELECT nome, cursos
FROM alunos
WHERE sexo = 'M' AND cursos = 'Programador';
...
/*Exercicio 6*/
SELECT MAX(altura) as MaiorAltura
FROM alunos
WHERE nacionalidade = 'Brasil' AND sexo = 'M';

/*Exercicio 7*/
SELECT AVG(peso) as MediaDePeso
FROM alunos;

/*Exercicio 8*/
SELECT MIN(peso) as MenorPeso
FROM alunos
WHERE sexo = 'F' AND nacionalidade <> 'Brasil' AND nascimento > '1990-01-01' AND nascimento < '2000-12-31';

/*Exercicio 9*/
SELECT COUNT(nome) as Mulheres
FROM alunos
WHERE sexo = 'F' AND altura > 1.90;

/*Exercicio 10*/
SELECT cursos, COUNT(cursos) as Cursos
FROM alunos
GROUP BY cursos;

/*Exercicio 11*/
SELECT sexo, COUNT(*) as total_alunos
FROM alunos
WHERE nascimento > '2005-01-01'
GROUP BY sexo;

/*Exercicio 12*/
SELECT nacionalidade, COUNT(nacionalidade) as TotalAlunos
FROM alunos
...
SELECT nome, altura
FROM alunos
WHERE altura > (SELECT AVG(altura) FROM alunos WHERE peso > 100);

SELECT altura, peso, count(peso) 
FROM alunos
WHERE peso >= 100
